            ...
            <form class="flex flex-col gap-4" onsubmit="handleFormSubmit(event)">
                ...
                <div class="flex flex-col gap-4">
                    <div class="flex flex-col">
                        ...
                        <select name="state" class="rounded" required>
                            <option class="rounded-md" value="" disabled selected>Pilih status</option>
                            <option value="packed">
                                Dikemas
                            </option>
                            <option value="update">
                    ...
                    <div class="flex flex-col">
                        ...
                        <textarea class="border border-2 rounded-lg px-3 py-1 font-bold h-48" name="message" required placeholder="Masukan pesan untuk pembaruan"></textarea>
                    </div>
                </div>
                                ...
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    <thead class="bg-[#FF9130]">
                                        <tr>
                                            ...
                                            <th class="px-6 py-3 text-start font-bold text-white uppercase"></th>
                                    ...
                                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                        <?php for ($i = 0; $i < count($results); $i++) { ?>
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200"><?= htmlspecialchars_decode($results[$i]["user"]) ?></td>
                                                ...
                                                <!-- TODO: Add new "Courir Role" Only courir can change package state. -->
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-blue-500">
                                                    <button onclick="modal_<?= $results[$i]["id"] ?>.showModal()">Kelola</button>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
