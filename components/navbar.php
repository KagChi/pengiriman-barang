<nav class="w-full h-14 p-1 px-12 pt-8 justify-between flex flex-row">
    ...
    <div class="flex flex-row gap-8 h-full justify-end">
        ...
        <button class="text-white flex font-bold rounded-md h-10 w-28 items-center justify-center bg-[#FF9130]">
            SignIn
        </button>
    </div>
</nav>